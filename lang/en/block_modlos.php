...
$string['modlos_simimage_proxy']    = 'Use of Proxy when acquiring SIM images';
$string['modlos_simimage_proxy_desc']= 'If you are connected to Modlos via HTTPS and to the SIM via HTTP, SIM images may not be displayed in your Web browser. '.
                                      'If this function is enabled, Modlos will retrieve the SIM image on behalf of the Web browser.';
