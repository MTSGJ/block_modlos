...
$string['modlos_simimage_proxy']    = 'SIMイメージ取得時のプロキシの使用';
$string['modlos_simimage_proxy_desc']= 'ModlosにHTTPS 経由，SIMにHTTP経由で接続している場合，Webブラウザ上にSIMイメージが表示されない場合がある．'.
                                      'この機能を有効にすると，ModlosがWebブラウザに代わってSIM画像を取得する';
